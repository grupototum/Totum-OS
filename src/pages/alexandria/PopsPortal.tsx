...
// Mock data
const mockDepartamentos = ['Operações', 'Comercial', 'Marketing', 'Tecnologia', 'RH'];
const mockPops = [
  { id: '1', titulo: 'Onboarding de Novos Clientes', departamento: 'Operações', status: 'approved' },
  { id: '2', titulo: 'Procedimento de Vendas', departamento: 'Comercial', status: 'approved' },
  { id: '3', titulo: 'Criação de Campanha', departamento: 'Marketing', status: 'review' },
  { id: '4', titulo: 'Deploy em Produção', departamento: 'Tecnologia', status: 'approved' },
  { id: '5', titulo: 'Processo de Recrutamento', departamento: 'RH', status: 'draft' },
];
...
export default function PopsPortal() {
  ...
  const [departamentos] = useState(mockDepartamentos);
  const [pops] = useState(mockPops);
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-green-900">{mockPops.filter(p => p.status === 'approved').length}</p>
              </div>
            </div>
          </CardContent>
        </Card>
